...
def test_data
  @user_1 = User.create!(name: 'Kiwi', email: 'kiwibird@gmail.com', password: '123123')
  @user_2 = User.create!(name: 'Pam', email: 'pam@email.com', password: '123123')
  @party_1 = Party.create!(movie_id: 438_631, duration_of_party: 109, party_date: '2024-12-01', start_time: '07:23')
