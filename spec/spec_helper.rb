...
def test_data
  @user1 = User.create!(name: "Shawn", email: "shawn@website.com", password: "1234")
  @user2 = User.create!(name: "Anthea", email: "anthea@website.com", password: "1234")
  @user3 = User.create!(name: "Xero", email: "xero@spooky.com", password: "1234")
...
def oppenheimer_test_data
  ...
  stub_request(:get, "https://api.themoviedb.org/3/movie/872585/images?api_key=#{ENV["API_KEY"]}").
    ...
    stub_request(:get, "https://api.themoviedb.org/3/movie//images?api_key=67af88004fc9a5fe47497bb47e0dc073").
    with(
      headers: {
     'Accept'=>'*/*',
     'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
