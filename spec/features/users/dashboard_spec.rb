...
RSpec.describe "User Dashboard" do
  before do
    ...
    @viewing_party2 = @user2.viewing_parties.create!(name: "Vincent's 5 Dollar Shake Party", movie_title: "Shake it", host: "Vincent", event_date: "8/29/23", start_time: "2" )
    @viewing_party3 = @user2.viewing_parties.create!(name: "Butch's Watch Polishing Party", movie_title: "Watches a Documentary", host: "Vincent", event_date: "8/26/23", start_time: "3" )
    @user_viewing_party1 =
  ...
  describe "user dashboard show" do
    ...
    it "displays the viewing parties that the user has been invited to and created" do
      ...
      viewing_parties.each do |party|
        ...
        expect(page).to have_content(party.event_date)
