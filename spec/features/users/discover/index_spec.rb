  ...
  describe "Movies Results Page #9", :vcr do
    ...
    it "displays title, vote average, for 20 movie" do
      ...
      within("#movies") do
        ...
        expect(page).to have_content("Cuando Sea Joven Vote Average: 8.6")
        expect(page).to have_content("The Quintessential Quintuplets Movie Vote Average: 8.6")
        ...
        expect(page).to have_content("Parasite Vote Average: 8.5")
        expect(page).to have_content("The Dark Knight Vote Average: 8.5")
        expect(page).to have_content("The Green Mile Vote Average: 8.5")
        expect(page).to have_content("Pulp Fiction Vote Average: 8.5")
        expect(page).to have_content("The Good, the Bad and the Ugly Vote Average: 8.5")
        expect(page).to have_content("Forrest Gump Vote Average: 8.5")
        ...
        expect(page).to have_content("The Boy, the Mole, the Fox and the Horse Vote Average: 8.5")
        expect(page).to have_content("GoodFellas Vote Average: 8.5")
