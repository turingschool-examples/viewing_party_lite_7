...
RSpec.describe "/users/:id" do
  describe "As a visitor" do
    describe "when I visit the users show page" do
      ...
      let!(:movie_watch_party_1) { create(:movie_watch_party, watch_party_id: wapa_1.id, user_id: user_1.id, movie_id: movie_1.id) }
      let!(:movie_watch_party_2) { create(:movie_watch_party, watch_party_id: wapa_2.id, user_id: user_1.id, movie_id: movie_2.id) }
      let!(:movie_watch_party_3) { create(:movie_watch_party, watch_party_id: wapa_3.id, user_id: user_1.id, movie_id: movie_3.id) }
      ...
      it "has a section that lists viewing parties" do
        ...
        movie_watch_party_2.update(user_status: 0)
        movie_watch_party_3.update(user_status: 1)
