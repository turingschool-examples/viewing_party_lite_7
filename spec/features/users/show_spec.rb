...
RSpec.describe "the /users/:id page", type: :feature do
  describe "When a user is valid, and visits their dashboard", :vcr do
    it "they should see their name, a button to discover movies, and a list of their viewing parties" do
      ...
      viewing_party1 = ViewingParty.create!(movie_id: 1, movie_title: "Jaws", movie_image: "/b0Ej6fnXAP8fK75hlyi2jKqdhHz.jpg", duration: 120, date: "12/10/2023", start_time: "12:30:00")
      viewing_party2 = ViewingParty.create!(movie_id: 2, movie_title: "The Shining", movie_image: "/kdPMUMJzyYAc4roD52qavX0nLIC.jpg", duration: 90, date: "13/10/2023", start_time: "17:15:00")
