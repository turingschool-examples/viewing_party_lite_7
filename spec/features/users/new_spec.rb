    ...
    describe "when I visit the registration page" do
      ...
      describe "happy path" do
        it "can create a new user" do
          ...
          expect(page).to have_content(user.email.downcase)
        end
      end
      ...
      describe "sad path" do
        ...
        it "will not create a user without acceptable parameters" do
          visit register_user_path
          fill_in(:name, with: "")
          fill_in(:email, with: "Joey@joeyjoey.com")
          fill_in(:password, with: "test")
          ...
          fill_in(:password_confirmation, with: "still_not_test_5")
          click_button "Submit"
