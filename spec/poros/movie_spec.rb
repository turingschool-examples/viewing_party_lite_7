...
RSpec.describe Movie do 
  it 'exists' do 
    movie = Movie.new({id: 1, title: 'Barbie', vote_average: 7.5, runtime: 123, genres: 'comedy', overview: 'Barbie and Ken are having the time of their lives in the colorful and seemingly perfect world of Barbie Land. However, when they get a chance to go to the real world, they soon discover the joys and perils of living among humans.'})
  ...
  describe 'instance methods' do 
    it 'has a formats total runtime into hrs and mins' do
      ...
      expect(movie.formatted_runtime).to eq('2hr 3min')
    end
  end 
end