  ...
  describe 'instance methods' do
    describe '#viewing_party_movie_ids' do
      it 'returns an array of all the viewing parties\' movie id\'s' do
        ...
        user_viewing_party1 = create(:user_viewing_party, user: user, viewing_party: viewing_party1)
        user_viewing_party2 = create(:user_viewing_party, user: user, viewing_party: viewing_party2)
        user_viewing_party3 = create(:user_viewing_party, user: user, viewing_party: viewing_party3)
