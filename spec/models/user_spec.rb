...
RSpec.describe User, type: :model do
  ...
  describe 'instance methods' do
    ...
    it '#hosted_parties & #invited_parties' do
      @user_1 = User.create!(name: "Bob", email: "bob@bobbington.com")
      @user_2 = User.create!(name: "Jeff", email: "jeffrey@jeff.com")
      @user_3 = User.create!(name: "Sally", email: "salamander@bob.com")
