...
RSpec.describe ViewingParty, type: :model do
  ...
  describe 'class methods' do
    before(:each) do
      ...
      @viewing_party_3 = ViewingParty.create!(movie_id: 203, duration: 145, date: '2020-06-11', start_time: '2021-06-011 14:00:00 UTC', user_id: @user_1.id)
    ...
    it "::find_hosted_parties" do
      ...
      expect(output).to eq([@viewing_party_1, @viewing_party_3])
  ...
  describe "instance methods",:vcr do
    it "#poster" do
      ...
      result = @viewing_party_1.poster(@viewing_party_1.movie_id)
    
      expect(result).to eq("/8kSerJrhrJWKLk1LViesGcnrUPE.jpg")
    end
  end
