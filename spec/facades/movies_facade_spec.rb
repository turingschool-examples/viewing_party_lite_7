...
RSpec.describe MoviesFacade do
  ...
  it "exists and has readable attributes" do
    movie_facade = MoviesFacade.new({id: 1, title: "The Dark Knight", top_movies: ["The Godfather", "The Dark Knight", "Good Will Hunting", "The Shawshank Redemption"], user_id: @user_1.id})
    ...
    expect(movie_facade.top_movies).to eq(["The Godfather", "The Dark Knight", "Good Will Hunting", "The Shawshank Redemption"])
    expect(movie_facade.user).to eq(@user_1)
  end

  it "#discover_options with top movies" do
    movie_facade = MoviesFacade.new({id: 1, title: nil, top_movies: ["The Godfather", "The Dark Knight", "Good Will Hunting", "The Shawshank Redemption"], user_id: @user_1.id})
