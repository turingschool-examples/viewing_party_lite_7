...
RSpec.describe MoviesFacade do
  ...
  it "#invited_viewing_parties" do
    ...
    viewing_party_1 = ViewingParty.create!(duration: 300, date: "2050-08-05", start_time: "12:00:00", movie_id: 238, host_user_id: user_2.id)
  ...
  it "#hosted_viewing_parties" do
    users_facade = UsersFacade.new({id: @user_1.id})
    user_2 = User.create!(name: "Kaylee", email: "kaylee@example.com")
    viewing_party_1 = ViewingParty.create!(duration: 300, date: "2050-08-05", start_time: "12:00:00", movie_id: 238, host_user_id: @user_1.id)
