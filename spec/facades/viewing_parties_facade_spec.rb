...
RSpec.describe MoviesFacade do
  ...
  it "exists and has readable attributes" do
    viewing_parties_facade = ViewingPartiesFacade.new({movie_id: 238, user_id: @user_1.id, duration: 300, runtime: 175, date: "2050-08-05", start_time: "12:00:00"})
    ...
    expect(viewing_parties_facade.params).to eq({movie_id: 238, user_id: @user_1.id, duration: 300, runtime: 175, date: "2050-08-05", start_time: "12:00:00"})
  end
  ...
  it "#create_user_viewing_party" do
    ...
    viewing_parties_facade = ViewingPartiesFacade.new({movie_id: 238, user_id: @user_1.id, duration: 300, runtime: 175, date: "2050-08-05", start_time: "12:00:00", "#{user_2.id}": "1", "#{user_3.id}": "0"})
