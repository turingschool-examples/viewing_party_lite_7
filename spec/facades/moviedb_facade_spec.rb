...
RSpec.describe MoviedbFacade do
  describe "instance methods" do
    context "#get_movie_search" do
      xit "returns array of movie objects" do
        ...
        expect(MoviedbFacade.new.get_movies_search("space od")).to be_an(Array)
        expect(MoviedbFacade.new.get_movies_search("space od").first).to be_a(Movie)
      end
    end
